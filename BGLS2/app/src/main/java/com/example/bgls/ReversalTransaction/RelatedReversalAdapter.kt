...
class RelatedReversalAdapter(
    private val list: List<ReversalDetailModel>,
    private val onItemClick: (Int) -> Unit
) : RecyclerView.Adapter<RelatedReversalAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.item_transactions_reversal_related, parent, false)
        return ViewHolder(v)
    }
