...
class KYCComplianceActivity : AppCompatActivity() {
    ...
    private fun setupData() {
        fullData = listOf(
            KYCItem("1", "RETAIL", "ARN0586", "INDIVIDUAL", "GIVI", "785412369"),
            KYCItem("2", "RETAIL", "ARN0613", "INDIVIDUAL", "LALITH KUMAR", "CUTFYFIUYGFIU"),
            KYCItem("3", "RETAIL", "ARN0776", "INDIVIDUAL", "UJWALA", "JGFBEHVFDCB"),
            KYCItem("4", "RETAIL", "ARN0701", "INDIVIDUAL", "VINAY", "IND7895412663"),
            KYCItem("5", "RETAIL", "ARN0815", "INDIVIDUAL", "SHASHA", "3456789876543"),
            KYCItem("6", "RETAIL", "ARN0946", "INDIVIDUAL", "PON PRASANTH", "E7GEOFYHE8IFY"),
            KYCItem("7", "RETAIL", "ARN0859", "INDIVIDUAL", "IRWIN KUMAR", "IRJIPGGNROGRJ"),
            KYCItem("8", "RETAIL", "ARN0905", "INDIVIDUAL", "PON PRASANTH", "UHOPRHGPRPIGP"),
            KYCItem("9", "RETAIL", "ARN0607", "INDIVIDUAL", "VIMAL KUMAR", "RDCUTFCYFVIOU"),
            KYCItem("10", "RETAIL", "ARN0804", "INDIVIDUAL", "LALITH KUMAR", "FYIRYFYRFIURO")
        )
    }
